...
LastEditTime : 2025-01-19 02:10:38
FilePath     : /Documents/nnUNet/nnunetv2/training/dataloading/data_loader_3d.py
Description  :
I Love IU
...
class nnUNetDataLoader3D(nnUNetDataLoaderBase):
    def generate_train_batch(self):
        ...
        for j, i in enumerate(selected_keys):
            ...
            data, seg, properties, subtype = self._data.load_case(i)
