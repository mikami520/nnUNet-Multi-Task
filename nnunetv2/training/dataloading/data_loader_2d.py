...
LastEditTime : 2025-01-19 02:02:19
FilePath     : /Documents/nnUNet/nnunetv2/training/dataloading/data_loader_2d.py
Description  :
I Love IU
...
class nnUNetDataLoader2D(nnUNetDataLoaderBase):
    def generate_train_batch(self):
        ...
        subtype_all = np.zeros((self.data_shape[0],), dtype=np.int16)
        case_properties = []
        ...
        for j, current_key in enumerate(selected_keys):
            ...
            data, seg, properties, subtype = self._data.load_case(current_key)
        ...
        subtype_all = torch.from_numpy(subtype_all).to(torch.int16)
            ...
            with torch.no_grad():
                with threadpool_limits(limits=1, user_api=None):
                    ...
                    if isinstance(segs[0], list):
                        ...
                        subtype_all = [
                            subtype_all for _ in range(self.num_subtypes_classes)
                        ]
                    else:
