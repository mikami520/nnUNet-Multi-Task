...
LastEditTime : 2025-01-24 00:36:14
FilePath     : /nnUNet-Multi-Task/nnunetv2/training/dataloading/nnunet_dataset.py
Description  :
I Love IU
...
class nnUNetDataset(object):
    def __init__(
        ...
        if isfile(join(parent_path, "type_info.json")):
            with open(join(parent_path, "type_info.json"), "r") as f:
        ...
        for c in case_identifiers:
            ...
            self.dataset[c]["subtype"] = (
                self.type_info["train"][c]["subtype"]
                if "subtype" in self.type_info["train"][c].keys()
                else None
            )
    ...
    def load_case(self, key):
        ...
        return data, seg, entry["properties"], entry["subtype"]
