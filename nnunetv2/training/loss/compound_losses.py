...
LastEditTime : 2025-01-18 22:12:52
FilePath     : /Documents/nnUNet/nnunetv2/training/loss/compound_losses.py
Description  :
I Love IU
...
class DC_and_Focal_loss(nn.Module):
    ...
    def forward(self, net_output, target):
        ...
        focal_loss = (
            self.focal(net_output, target[:, 0].long()) if self.weight_focal != 0 else 0
        )
